...
public class ReceiptInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences first_pref_receipt_info = getSharedPreferences("first_pref_receipt_info3", MODE_PRIVATE);
        boolean firstStartReceiptInfo = first_pref_receipt_info.getBoolean("first_start_receipt_info3", true);
                ...
                receipts_info_done.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        else
                        {
                            ...
                            editor.putString("key1xx", receipt_title.getText().toString());
                            editor.putString("key2xx", addline1.getText().toString());
                            editor.putString("key3xx", addline2.getText().toString());
                            editor.putString("key4xx", addline3.getText().toString());
                            editor.putString("key5xx", pincode.getText().toString());
                            editor.commit();


                            mySharedPreferences = getSharedPreferences(MY_PREFS, prefMode);
                            String string1 = mySharedPreferences.getString("key1xx", null);
                            String string2 = mySharedPreferences.getString("key2xx", null);
                            String string3 = mySharedPreferences.getString("key3xx", null);
                            String string4 = mySharedPreferences.getString("key4xx", null);
                            String string5 = mySharedPreferences.getString("key5xx", null);
                            ...
                            editor1.putBoolean("first_start_receipt_info3", false);
                            editor1.apply();
                        }
                    }
                });
