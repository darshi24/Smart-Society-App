...
public class SocietyName extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences first_pref_soc_name = getSharedPreferences("first_pref_soc_name3", MODE_PRIVATE);
        boolean firstStartSocName = first_pref_soc_name.getBoolean("first_start_soc_name3", true);
            ...
            set_society_name_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    else
                    {
                        ...
                        editor.putBoolean("first_start_soc_name3", false);
                        editor.apply();
