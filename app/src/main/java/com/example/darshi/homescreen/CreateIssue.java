...
public class CreateIssue extends DialogFragment implements DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        NewIssueRef.child(g.getSname()).child("IssueMaster").addValueEventListener(new ValueEventListener() {
            @Override
...
//        vote_time_deadline_btn.setText(time);
        vote_time_deadline_btn.setText(selectedHour+" : "+selectedMinute);
        c++;
    }
}
